		...
		$(window).load(function() {
          ...
          triggerTabList.forEach(function (triggerEl) {
            ...
            triggerEl.addEventListener('click', function (event) {
			  if (triggerEl.href.indexOf('table') >= 0)
			    window.localStorage.setItem('defaultView', 'table');

			  if (triggerEl.href.indexOf('animated') >= 0)
			    window.localStorage.setItem('defaultView', 'animated');
		  ...
		  let mySelectedView = window.localStorage.getItem("defaultView"); // table / animated
		  if (typeof(mySelectedView) === 'undefined' || mySelectedView === null) {
			  mySelectedView = 'animated';
			  window.localStorage.setItem('defaultView', mySelectedView);
		  }

		  switch (mySelectedView) {
			  case 'animated': $('[href="#animated"]').tab('show'); break;
			  case 'table': $('[href="#table"]').tab('show');break;

			  default: $('[href="#animated"]').tab('show'); break;
		  }
        });
})(jQuery);	